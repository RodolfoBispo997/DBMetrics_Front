        ...
        <div className="rounded-lg border border-border bg-background p-6 shadow-sm">
          <dl className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <dd className="text-base font-semibold text-foreground">{data.name}</dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="text-base font-semibold text-foreground">{data.host}</dd>
            </div>
            <div>
              <dt className="text-sm font-medium text-muted-foreground">Port</dt>
              <dd className="text-base font-semibold text-foreground">{data.port}</dd>
            </div>
            <div>
